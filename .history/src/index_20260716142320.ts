...
async function startApp() {
  ...
  const answers = await inquirer.prompt([
    {
      type: "select", // Способ ввода: выбор из списка стрелочками (ранее был "list")
      name: "source", // Имя коробочки, куда сохранится ответ. Ключ в результирующем объекте (data будет лежать в answers.source
